    ...
    <div class="container primary">
        <section class="wrapper clearfix">
          <div class="artwork_header">
            <h1><span class="artistTitle">Eugene Alonzo Poole (American 1841 – 1912)</span> River Landscape in Early Autumn</h1>
